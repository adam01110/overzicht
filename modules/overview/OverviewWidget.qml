        ...
        ColumnLayout {
            ...
            Item {
                ...
                Rectangle {
                    anchors.fill: parent
                    radius: 0
                    color: ColorUtils.applyAlpha(Appearance.colors.colLayer1, root.workspaceOpacity)
                    border.width: 1
                    border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer0Border, 0.65)
                    ...
                    Rectangle {
                        ...
                        radius: 0
                        color: ColorUtils.applyAlpha(Appearance.colors.colSecondary, 0.08)
                    }
                    ...
                    Grid {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                radius: 0
                                clip: true
                                color: ColorUtils.applyAlpha(baseColor, root.workspaceOpacity)
                                border.width: 1
                                border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer0Border, 0.75)
