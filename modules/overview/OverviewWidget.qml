        ...
        ColumnLayout { // Workspaces
            ...
            Item {
                ...
                Rectangle {
                    ...
                    border.width: 1
                    border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer0Border, root.glassMode ? root.glassBorderOpacity : 0.65)
                    ...
                    Grid {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                border.width: 1
                                border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer0Border, root.glassMode ? root.glassBorderOpacity : 0.75)
